    ...
    <ScrollView>
      <View style={[styles.container, SylCommon.Card.container(theme)]}>
        ...
        <View style={styles.content}>
          <TouchableOpacity style={[styles.item,styles.borderRight]} onPress={() => {
          ...
          <TouchableOpacity
            ...
            <Image source={theme.assets.images.icons.table.email}
          ...
          <TouchableOpacity style={[styles.item, styles.borderTop, styles.borderRight]}>
...
const styles = StyleSheet.create({
  ...
  borderTop: {
    borderColor: '#FFE',
    borderStyle: 'dashed', borderTopWidth: 0.5
  },
  borderRight: {
    borderColor: '#FFE',
    borderStyle: 'dashed', borderRightWidth: 0.5
  },
  item: {
