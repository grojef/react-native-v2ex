...
const Privacy = ({route, navigation, loading}: ScreenProps) => {
  ...
  return (
    <View style={SylCommon.Layout.fill}>
      ...
      <Text>1.用户提供的信息：您可以在使用我们的应用程序时，通过我们的联系方式提供您的姓名、电子邮件地址和电话号码等联系信息，以便我们提供相关支持服务。</Text>
      ...
      <Text>我们使用您提供的联系信息来向您提供支持服务，例如回答您的问题或解决您的问题。我们使用设备信息和应用程序使用信息来改进我们的应用程序，并为您提供更好的用户体验。</Text>
      <Text>我们不会收集或存储您的通讯录信息，我们承诺不会泄露或出售您的个人信息给第三方。</Text>
      <Text style={{fontWeight:"bold"}}>安全性：</Text>
      <Text>我们会采取合理的措施来保护您的个人信息免遭丢失、滥用或篡改。我们使用安全套接字层（SSL）技术来加密通过我们的应用程序发送的所有数据。</Text>
